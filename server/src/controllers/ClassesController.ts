//Corpo (Request Body) dados para atualizaçao ou criação de um registro
//Route Params: Identificar qual recurso eu quero atualizar ou deletar
// Query Params: Paginação, filtros, ordenar
// (request.route)  (request.query) (request.body)
...
export default class ClassesController{
    ...
    async create (request:Request, response:Response){ //Cadastro
        const {
            name,
            avatar,
            whatsapp,
        ...
        await trx.commit(); //inseri td ao mesmo tempo no banco
